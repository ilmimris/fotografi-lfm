	...
	<div class="col-md-offset-1 col-md-10 dk-modal">
		<div id="showdesc" class="dk-content-desc content-desc dk-content-elite">
			...
			<div class="row" id="photos">
				<a href="#" onclick="open_detail.call(this)" data-id="" id="dk-modal-link-elite1">
				...
				<a href="#" onclick="open_detail.call(this)" data-id="" id="dk-modal-link-elite2">
			...
			<div class="row" id="photos">	
				<a href="#" onclick="open_detail.call(this)" data-id="" id="dk-modal-link-elite3">
				...
				<a href="#" onclick="open_detail.call(this)" data-id="" id="dk-modal-link-elite4">
				<div class="box col-md-5">
	...
	<div class="col-md-offset-1 col-md-10 dk-modal">
		<div id="showdesc" class="dk-content-desc content-desc dk-content-elite">
			...
			<div class="row dk-all" id="photos">
				<a href="#" onclick="open_detail.call(this)" data-id="" id="dk-modal-link-all1">
				...
				<a href="#" onclick="open_detail.call(this)" data-id="" id="dk-modal-link-all2">
				<div class="box col-md-3">
				...
				<a href="#" onclick="open_detail.call(this)" data-id="" id="dk-modal-link-all3">
				<div class="box col-md-3">
				...
				<a href="#" onclick="open_detail.call(this)" data-id="" id="dk-modal-link-all4">
				<div class="box col-md-3">
			...
			<div class="row dk-all" id="photos">	
				<a href="#" onclick="open_detail.call(this)" data-id="" id="dk-modal-link-all5">
				<div class="box col-md-3">
				...
				<a href="#" onclick="open_detail.call(this)" data-id="" id="dk-modal-link-all6">
				<div class="box col-md-3">
				...
				<a href="#" onclick="open_detail.call(this)" data-id="" id="dk-modal-link-all7">
				<div class="box col-md-3">
				...
				<a href="#" onclick="open_detail.call(this)" data-id="" id="dk-modal-link-all8">
				<div class="box col-md-3">
			...
			<div class="row dk-all" id="photos">
				<a href="#" onclick="open_detail.call(this)" data-id="" id="dk-modal-link-all9">
				<div class="box col-md-3">
				...
				<a href="#" onclick="open_detail.call(this)" data-id="" id="dk-modal-link-all10">
				<div class="box col-md-3">
				...
				<a href="#" onclick="open_detail.call(this)" data-id="" id="dk-modal-link-all11">
				<div class="box col-md-3">
				...
				<a href="#" onclick="open_detail.call(this)" data-id="" id="dk-modal-link-all12">
				<div class="box col-md-3">
			...
			<div class="row dk-all" id="photos">	
				<a href="#" onclick="open_detail.call(this)" data-id="" id="dk-modal-link-all13">
				<div class="box col-md-3">
				...
				<a href="#" onclick="open_detail.call(this)" data-id="" id="dk-modal-link-all14">
				<div class="box col-md-3">
				...
				<a href="#" onclick="open_detail.call(this)" data-id="" id="dk-modal-link-all15">
				<div class="box col-md-3">
				...
				<a href="#" onclick="open_detail.call(this)" data-id="" id="dk-modal-link-all16">
				<div class="box col-md-3">
