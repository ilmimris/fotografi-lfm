...
<div class="container-fluid">
	<div class="row">
		<div class="col-xm-12 col-sm-12 col-md-12 col-lg-12">
			<img class="logo-brand img-center" src="<?= img_url()?>start.png">
			<p class="contactus">
			Sekretariat Liga Film Mahasiswa ITB
			Jalan Ganesha 10, Bandung
			Indonesia

			022 - 2510627

			liga_film_mahasiswa@yahoo.co.id</p>
			<div class="socmed">
			...
			<p class="contactus" style="font-size: 1.5em; margin-top: 4%;">&copy; Copyright Fotografi LFM ITB 2016</p>
		</div>
	</div>
</div>