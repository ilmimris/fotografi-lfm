	...
	<div class="modal-content">
		...
		<div id="input-photo-form">
			<div class="col-md-6">
				...
				<input id="input-photo-contributor" name="contributor" class="form-control" placeholder="Contributor" type="text" value="" required="required" autofocus>
